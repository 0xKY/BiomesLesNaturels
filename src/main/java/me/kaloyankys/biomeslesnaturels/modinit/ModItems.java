...
import me.kaloyankys.biomeslesnaturels.item.WindBottle;
...
public final class ModItems {
    ...
    public static final Item WIND_BOTTLE = new WindBottle(new FabricItemSettings().group(ItemGroup.MISC));
    ...
    public ModItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier("biomeslesnaturels", "bottled_wind"), WIND_BOTTLE);
