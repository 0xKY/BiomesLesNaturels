...
public class ModBlocks {
    ...
    public ModBlocks() {
        ...
        Registry.register(Registry.BLOCK, new Identifier("biomeslesnaturels", "limestone_bricks"), SMOOTH_LIMESTONE_BRICKS);
        Registry.register(Registry.ITEM, new Identifier("biomeslesnaturels", "limestone_bricks"), new BlockItem(SMOOTH_LIMESTONE_BRICKS, new FabricItemSettings().group(ItemGroup.DECORATIONS)));
