...
public class BiomeslesnaturelsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(),
                ModBlocks.OAT_GRASS, ModBlocks.OAT_GRASS_SMALL, ModBlocks.SUNLEAF, ModBlocks.OAT_BUNDLE, ModBlocks.GOATBERRY, ModBlocks.MINT, ModBlocks.WIND, ModBlocks.FLOURISHING_WINDGRASS, ModBlocks.EBONY_TREE, ModBlocks.EDELWEISS, ModBlocks.OLIVE_TREE);
        //Particle Factories
